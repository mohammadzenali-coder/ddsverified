...
# ---------------------------------------------------------------- intros ----
INTROS = {
    "needle": "فرز نیدل (سوزنی) به دلیل نوک بسیار ظریف و بلند خود، ابزار اصلی دسترسی به حفرات عمقی دندانی، آماده‌سازی کانال‌های ریشه و ترمیم‌های دقیق بین دندانی است. فرزهای الماسی نیدل DDSVerified پیش از ارسال توسط دندانپزشک تست می‌شوند تا از کیفیت الماسی و عدم لرزش روی هد توربین مطمئن شوید.",
...
FAQS = {
    "_common": [
        ("آیا فرزها اصل و تست‌شده هستند؟", "بله؛ تمام فرزهای DDSVerified پیش از ارسال شخصاً توسط دندانپزشک تست می‌شوند و دارای گواهی TÜV Rheinland آلمان و ISO هستند."),
